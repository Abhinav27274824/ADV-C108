...
function gotResult(error, results) {
    if(error){
        ...
        document.getElementById("resultLabel").style.fontFamily = 'Courier New'+","+'Courier'+","+'monospace';

        document.getElementById("resultConfidence").innerHTML = "Detected Voice Is Of - "+results[0].label;
        document.getElementById("resultConfidence").style.color = "rgb("+random_number_r+","+random_number_g+","+random_number_b+")";
        document.getElementById("resultConfidence").style.fontFamily = 'Courier New'+","+'Courier'+","+'monospace';
        ...
        if(results[0].label == "Barking"){
            ...
            dog = dog+1;
            document.getElementById("resultLabel").innerHTML = "Detected Dog - "+ dog;
        }
        else if(results[0].label == "Meowing"){
            img.src = "https://shravaripatil.github.io/Sound_controlled_animals/meow.gif";
            cat = cat+1;
            document.getElementById("resultLabel").innerHTML = "Detected Cat - "+ cat;
        }
            ...
            lion = lion+1;
            document.getElementById("resultLabel").innerHTML = "Detected Lion - "+ lion;
        }
            ...
            cow = cow+1;
            document.getElementById("resultLabel").innerHTML = "Detected Cow - "+ cow;
        }
        else{
            img.src = "https://shravaripatil.github.io/Sound_controlled_animals/listen.gif";
            background_noise = background_noise+1;
            document.getElementById("resultLabel").innerHTML = "Detected Background Noise - "+ background_noise;
        }
    }
}